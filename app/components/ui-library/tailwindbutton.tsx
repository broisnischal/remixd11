...
export const ConnectButton = ({
	...
	return (
		...
		>
			...
			<span
				className={twMerge(
					'absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-emerald-400/0 to-emerald-400/0 transition-opacity duration-500 group-hover:opacity-40',
					focuscolor,
				)}
			/>
		</button>
