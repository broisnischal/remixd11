...
export default function Component() {
	...
	return (
		<div>
			...
			<div className="prose-strong:font-inconsolata prose-code:font-inconsolata prose prose-zinc max-w-[95w] overflow-hidden dark:prose-invert lg:prose-xl prose-p:font-atkinson prose-strong:rounded-md prose-strong:bg-secondary prose-strong:px-2 prose-strong:py-1 prose-code:rounded-md  prose-code:text-sm prose-table:overflow-x-auto prose-img:rounded-md  ">
				<Outlet />
			</div>
			<br />
			<br />
