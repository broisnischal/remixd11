...
meta:
  ...
  image: https://nischal-dahal.com.np/resources/og-image?title=Where%20to%20host%20your%20modern%20application&description=Hosting&date=2024-08-11
featured: true
image: https://nischal-dahal.com.np/resources/og-image?title=Where%20to%20host%20your%20modern%20applications&description=Hosting&date=2024-08-11
...
readTime: 20
author: Nischal Dahalk
---

import { MetaCreator } from '../utils/meta';

export const meta = ({ attributes }) => {
    const url = new URL(`https://nischal-dahal.com.np/blog/where-to-host-your-modern-applications`);
