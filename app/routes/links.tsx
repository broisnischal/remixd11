			...
			<div className="flex flex-wrap items-center justify-center gap-4">
				{socialLinks.map((link, index) => (
					<Link aria-label={link.name} target="_blank" to={link.url}>
						<div
							key={index}
							className="flex items-center justify-between gap-4 rounded-md border bg-[#f6f6f6] px-4 py-2 dark:bg-[#191919] "
						>
							<div className="flex items-center gap-4">
								...
								{/* <p className="secondary">{link.description}</p> */}
							</div>
...
const socialLinks: {
	...
	},
	{
		...
		icon: <YoutubeIcon width={30} height={30} />,
		action: 'SUB',
	},
	{
		name: 'Whatsapp',
...
// 	url: '',
// 	icon: <RssIcon width={30} height={30} />,
// 	action: 'Feed',
// },
